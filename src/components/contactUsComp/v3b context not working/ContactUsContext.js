...
export const ContactUsContext = createContext();
export const ContactUsProvider = ({ element }) => { //{children} //0
    //const { dropDownManuShown } = useApp();
    ...
    return (
        <ContactUsContext.Provider value={{ userData, errMsg, submitted, dispatch}}> 
            { element }
...
//<ContactUsContext.Provider value={value}> //c
